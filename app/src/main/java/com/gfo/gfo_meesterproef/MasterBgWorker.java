...
public class MasterBgWorker extends AsyncTask<String, Void, List<String>> {
    ...
    void setPath(String type){
        ...
        if(type.equals("link")) {             php_url = "https://mantixcloud.nl/gfo/link/link.php";}
        if(type.equals("uncouple")) {           php_url = "https://mantixcloud.nl/gfo/link/uncouple.php";}
        if(type.equals("allProducts")) {        php_url = "https://mantixcloud.nl/gfo/products_files/viewproducts.php";}
        if(type.equals("coupledProducts")) {    php_url = "https://mantixcloud.nl/gfo/link/coupledproduct.php";}
        if(type.equals("allAccounts")) {        php_url = "https://mantixcloud.nl/gfo/account/viewusername-user.php";}
        if(type.equals("coupledAccounts")) {    php_url = "https://mantixcloud.nl/gfo/link/coupledaccount.php";}
